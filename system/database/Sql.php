...
class Sql {
  ...
  public function fetchAll() {
    ...
    $sql = sprintf($format, $this->table, $this->filter);
  ...
  public function delete($id) {
    ...
    $sql = sprintf($format, $this->table, $this->primary, $this->primary);
    $sth = Db::pdo()->prepare($sql);
  ...
  public function add($data) {
    ...
    $sql = sprintf($format, $this->table, $this->formatInsert($data));
    $sth = Db::pdo()->prepare($sql);
  ...
  public function update($data) {
    ...
    $sql = sprintf($format, $this->table, $this->formatUpdate($data), $this->filter);
    $sth = Db::pdo()->prepare($sql);
    $sth = $this->formatParam($sth, $data);
    $sth = $this->formatParam($sth, $this->param);
    $sth->execute();
  ...
  private function formatInsert($data) {
    ...
    $format = '(%s) values (%s)';
    return sprintf($format, $field, $name);
  }
